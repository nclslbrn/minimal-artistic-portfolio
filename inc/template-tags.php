...
if ( ! function_exists( 'mapposted_on' ) ) :
	/**
...
if ( ! function_exists( 'mapentry_footer' ) ) :
	/**
 ...
 * @return bool
 */
function map_categorized_blog() {
	if ( false === ( $all_the_cool_cats = get_transient( 'mapcategories' ) ) ) {
		...
		set_transient( 'mapcategories', $all_the_cool_cats );
	}

	if ( $all_the_cool_cats > 1 ) {
		// This blog has more than 1 category so mapcategorized_blog should return true.
		return true;
	} else {
		// This blog has only 1 category so mapcategorized_blog should return false.
		return false;
	}
}
