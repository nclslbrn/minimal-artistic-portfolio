...
<header class="entry-header">
	<h1 class="entry-title"><?php esc_html_e( 'Nothing Found', 'Minimal-Artistic-Portfolio' ); ?></h1>
</header><!-- .page-header -->
...
<div class="entry-content">
	...
	<?php elseif ( is_search() ) : ?>
		...
		<p><?php echo esc_html__( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'Minimal-Artistic-Portfolio' ); ?></p>
		<br>
		<?php
			get_search_form();
