...
function minimal_artistic_portfolio_scripts() {
	...
	wp_enqueue_script( "Minimal-Artistic-Portfolio-navigation", get_template_directory_uri() . "/prod/js/navigation.js", array(), "20151215", true );

	wp_enqueue_script( "Minimal-Artistic-Portfolio-skip-link-focus-fix", get_template_directory_uri() . "/prod/js/skip-link-focus-fix.js", array(), "20151215", true );
...
function map_stylesheet() {
	...
	wp_enqueue_script('fluidBoxScript', get_template_directory_uri() . '/prod/js/jquery.fluidbox.min.js');
	wp_enqueue_script('project-fluidBoxScript', get_template_directory_uri() . '/prod/js/project-fluidBox.js');
	//wp_enqueue_script('fluidBoxScript', get_template_directory_uri() . '/prod/js/jquery.ba-throttle-debounce.min.js');
