...
export default function () {
	...
	const switchTheme = (e) => {
		...
		} // hidden input[type="checkbox"][name="mode-switcher"] switch
		if (e && e.currentTarget && "undefined" !== e.currentTarget.value) {
			mode = e.currentTarget.value;
		} // select|input[name="mode-switcher"] menu & buttons
	...
	const updateSelect = (isDark) => {
		...
		const themeSelect = document.querySelectorAll(
